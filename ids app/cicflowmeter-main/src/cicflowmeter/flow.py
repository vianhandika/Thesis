...
class Flow:
    ...
    def get_data(self) -> dict:
        ...
        data = {
            ...
            "flow_byts/s": flow_bytes.get_rate(),
            "flow_pkts/s": packet_count.get_rate(),
            "fwd_pkts/s": packet_count.get_rate(PacketDirection.FORWARD),
            "bwd_pkts/s": packet_count.get_rate(PacketDirection.REVERSE),
            ...
            # Response Time
            "down/up_ratio": packet_count.get_down_up_ratio(),
